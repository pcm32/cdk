 ...
 *   BitSet fingerprint = HybridOnlyFingerprinter.getFingerprint(molecule);
 ...
 * @cdk.githash
 */
@TestClass("org.openscience.cdk.fingerprint.HybridOnlyFingerprinterTest")
public class HybridOnlyFingerprinter implements IFingerprinter {
	 ...
	 */
	public HybridOnlyFingerprinter() {
		this(DEFAULT_SIZE, DEFAULT_SEARCH_DEPTH);
	}
	
	public HybridOnlyFingerprinter(int size) {
	 ...
	 */
	public HybridOnlyFingerprinter(int size, int searchDepth) {
		this.size = size;
